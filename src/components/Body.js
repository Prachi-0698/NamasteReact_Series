    ...
    <div className="body">
      <div className="flex justify-between mt-4 mx-6 ">
        ...
        <div className="search-filter">
          ...
          <input
            className="m-3 p-2 rounded-md border-0 bg-transparent outline-0 text-gray-500 focus:ring-2 focus:ring-inset focus:ring-orange-300 placeholder:p-2 "
            type="text"
            value={searchText}
            onChange={(e) => {
          ...
          ></input>
          <button
            className="p-2 px-4 bg-orange-300 text-white text-bold rounded-xl"
            onClick={() => {
